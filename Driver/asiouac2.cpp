...
//#define DRVNAME "iFi HD USB Audio"
//#define REGNAME "SOFTWARE\\ASIO\\iFi HD USB Audio"
//#define DLLNAME "asiouac2.dll"
//#define TPPNAME2 L"ASIOUAC2"
//#define TPPNAME "ASIOUAC2"
//CLSID IID_ASIO_DRIVER = { 0xccb9056b, 0x7b74, 0x4677, { 0x8b, 0xde, 0x65, 0xe4, 0x2a, 0xdb, 0x7a, 0x6a } };

#define TPPNAME2 L"ASIOXCORE"
#define DRVNAME "xCORE USB Audio"
#define DLLNAME "xCOREUSBAudio.dll"
#define TPPNAME "ASIOXCORE"
CLSID IID_ASIO_DRIVER = { 0xccb9056b, 0x7b74, 0x4677, { 0x8b, 0xde, 0x65, 0xe4, 0x2a, 0xdb, 0x7a, 0x6b } };
//CLSID IID_ASIO_DRIVER = { 0x73F07B04, 0x45F4, 0x2F02, { 0x2C, 0x9B, 0x4C, 0xAC, 0xE5, 0x1C, 0x03, 0x18 } };
const char driverDescriptionLong[] = DRVNAME;
const char driverDescriptionShort[] = DRVNAME;
const char driverDllName[] = DLLNAME;
...
CFactoryTemplate g_Templates[1] = {
	{ TPPNAME2, &IID_ASIO_DRIVER, AsioUAC2::CreateInstance }
};
...
: CUnknown(TPPNAME, pUnk, phr), callbacks(NULL), inputBuffers(NULL), outputBuffers(NULL),
